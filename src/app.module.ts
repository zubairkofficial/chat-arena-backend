...
@Module({
  imports: [TypeOrmModule.forRoot(databaseConfig),UserModule, GoogleAuthModule, PersonaModule, ArenaModule, AifigureModule, ConversationModule, MessageModule, AchievementModule, ReactionModule, ResponseStyleModule, ArenaTypeModule, UserArenaModule],
