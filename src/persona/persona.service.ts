...
export class PersonaService {
  ...
  async create(createPersonaDto:PersonaDto.CreatePersonaDto): Promise<Persona> {
  ...
  async update(id: string, updatePersonaDto:PersonaDto.UpdatePersonaDto): Promise<Persona> {
