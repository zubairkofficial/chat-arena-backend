...
export class ArenaTypeService extends BaseService {
  ...
  async createArenaType(input: ArenaTypeDto.CreateArenaTypeDto): Promise<ArenaType> {
  ...
  async createManyArenaTypes(createArenaTypeDtos: ArenaTypeDto.CreateArenaTypeDto[]): Promise<ArenaType[]> {
    const transactionScope = this.getTransactionScope();
  ...
  async updateArenaType(id: string, updateArenaTypeDto: ArenaTypeDto.UpdateArenaTypeDto): Promise<ArenaType> {
    const transactionScope = this.getTransactionScope();
    ...
    arenaType.description = updateArenaTypeDto.description || arenaType.description;
